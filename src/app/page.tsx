...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div id="content" className="relative bg-background">
                  ...
                  <div className="space-y-6">
                      ...
                      <div id="transformer-recap-simulation" className="pt-8">
                          ...
                          <p className="text-muted-foreground">
                              Now, let's see these concepts in action. This simulation will walk you through the core concepts of how a transformer processes input to generate output, one step at a time.
                          </p>
                      </div>
